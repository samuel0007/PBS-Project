...
def plot_frame(frame_number, result_matrix):
    ...
    try:
        ...
        mesh_0.set_edgecolor((0, 0, 0.2, 0.6))
        mesh_1.set_edgecolor((0, 0, 0.2, 0.))
        mesh_2.set_edgecolor((0, 0, 0.2, 0.))
        mesh_3.set_edgecolor((0, 0, 0.2, 0.))

        mesh_0.set_facecolor((0, 0, 0.2, 0.6))
        mesh_1.set_facecolor((0, 0, 0.2, 0.))
        mesh_2.set_facecolor((0, 0, 0.2, 0.))
        mesh_3.set_facecolor((0, 0, 0.2, 0.))
