...
RESULT_DIR = "results/run_flask_2/" # directory has to exist, otherwise crash
...
#      pointData_file=r"src/pointDataFiles/erlenmayer_quickerstart.npy", boundary_pointData_file = r"src/pointDataMetaFiles/flask_on_plane.txt")
# simulation.run()

# Render Simulation
renderer = Renderer(bounds=BOUNDS, result_dir=RESULT_DIR, radius=RADIUS*0.99, SHOW=True, render_boundary=True, render_density=False, mass=MASS, start_frame=500)
renderer.render()
