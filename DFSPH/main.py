...
# simulation = Simulation(NUM_PARTICLES, MAX_TIME, max_dt=MAX_DT, mass=MASS, rest_density=REST_DENSITY, support_radius=SUPPORT_RADIUS, mu=MU, bounds=BOUNDS, is_frame_export=True, debug=True, result_dir=RESULT_DIR)
# simulation.run()
